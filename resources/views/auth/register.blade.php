            ...
            <div class="p-6">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <button type="submit" class="w-full bg-blue-600 px-4 py-2 text-sm font-semibold text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition">
                                {{ __('Register') }}
                            </button>
                        </div>
                    </div>
